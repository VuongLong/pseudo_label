...
def train(domain_list, classnames, clip_model, preprocess, args):
    ...
    for target_name in domain_list:
        ...
        for source_name in source_name_list:
            ...
            tgt_save_path = os.path.join(args.output_dir, target_name, source_name)
            if os.path.exists(tgt_save_path):
                continue            
            ...
            source_train_dataset = SingleSourceDataset(
                args.data_root, [source_name], preprocess
            )
